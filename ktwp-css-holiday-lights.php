...
/* REMOVED FRAMEWORK SECTIONS 1, 2, 3 - not using for holiday lights 2025 */
...
/* NOTE: If you really wanted to completely avoid javascript, replace the above by checking for the 
   wp_body_open hook and using that if it's available, and falling back to javascript for the small 
   percentage of WP sites on WP or theme versions that don't support it: 
